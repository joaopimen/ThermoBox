...
# import numpy as np
# # Function to calculate molar concentration
# def calculate_molar_concentration(X, densities, molecular_weights, components):
#     # Calculate numerator and denominator for the molar concentration formula
#     numerator = sum(X[i] * densities[components[i]] for i in range(len(components)))
#     denominator = sum(X[i] * molecular_weights[components[i]] for i in range(len(components)))
#     # Molar concentration in mol/L
#     molar_concentration = numerator / denominator
#     return molar_concentration

# def calculate_phase_volume(N, comp, molecular_weights, densities):
#     """
#     Calculate the total volume of a phase.
...
#     volume = 0
#     for i, component in enumerate(comp):
#         MW = molecular_weights[component]  # Molecular weight (g/mol)
#         rho = densities[component]  # Density (g/L)
#         volume += N[i] * MW / rho  # Contribution to phase volume
#     return volume
